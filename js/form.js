...
const [...errorMessage] = ['Please enter your name', 'Email should be lower case in format user@mail.com', 'Please enter your message'];
...
addEventListeners(formInputs, 'change', () => {
  localStorage.setItem('name', formInputs.value);
